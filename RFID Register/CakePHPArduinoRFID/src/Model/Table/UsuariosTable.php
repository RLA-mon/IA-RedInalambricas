...
class UsuariosTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('usuarios_us')
            ->maxLength('usuarios_us', 255)
            ->requirePresence('usuarios_us', 'create')
            ->notEmptyString('usuarios_us');

        $validator
            ->scalar('password_us')
            ->maxLength('password_us', 255)
            ->requirePresence('password_us', 'create')
            ->notEmptyString('password_us');
